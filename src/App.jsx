...
export const PRODUCTS = [
  ...
  { id: 3,  name: "Magic Mug",             price: 150, stock: 6, category: "mugs",      tag: "deal",       description: "Heat-sensitive magic mug — design appears when hot liquid is added. The perfect gift!", colors: ["#d8f0fd","#b4e3f9","#90d6f5"], originalPrice: 150, img: "magic-mug.jpg" },
  { id: 30,  name: "Magic Mug",             price: 150, stock: 6, category: "mugs",      tag: "deal",       description: "Heat-sensitive magic mug — design appears when hot liquid is added. The perfect gift!", colors: ["#d8f0fd","#b4e3f9","#90d6f5"], originalPrice: 150, img: "magic-mug.jpg" },
  { id: 31,  name: "Magic Mug",             price: 150, stock: 6, category: "mugs",      tag: "deal",       description: "Heat-sensitive magic mug — design appears when hot liquid is added. The perfect gift!", colors: ["#d8f0fd","#b4e3f9","#90d6f5"], originalPrice: 150, img: "magic-mug.jpg" },
  { id: 32,  name: "Magic Mug",             price: 150, stock: 6, category: "mugs",      tag: "deal",       description: "Heat-sensitive magic mug — design appears when hot liquid is added. The perfect gift!", colors: ["#d8f0fd","#b4e3f9","#90d6f5"], originalPrice: 150, img: "magic-mug.jpg" },
  // ── APPAREL
  ...
  // ── PRINTING
  { id: 13, name: "Flyers design (from R150)",    price: 150, category: "printing",  tag: "deal",       description: "A5/A4 glossy flyers — design included. Perfect for events, promos and marketing.",      colors: ["#f5fff0","#d8f5c8","#bbeba0"], img: "flyers.jpg" },
